...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_12)     //CLK   D0
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_12)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_13)//DIN    D1
...
void Oled_Printf_Float(unsigned char x,unsigned char y,float num);
