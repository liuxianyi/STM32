...
#include "lcd.h"
#include "led.h"												 
extern void setPBout(u8 sta);
extern void setPEout(u8 sta);
...
struct _m_usmart_nametab usmart_nametab[]=
{
	...
	(void*)setPBout,"setPBout(u8 sta);",
	(void*)setPEout,"setPEout(u8 sta);",
	//(void*)test_fun,"void test_fun(void(*ledset)(u8),u8 sta)",
	//(void*)pinSetlow,"void pinSetlow(GPIO_TypeDef* GPIOx, GPIOMode_TypeDef GPIO_Mode_X, GPIOSpeed_TypeDef GPIO_Speed_XMHZ, uint16_t GPIO_Pin, uint16_t RCC_APB2Periph);",
	//(void*)pinSetHigh,"void pinSetHigh(GPIO_TypeDef* GPIOx, GPIOMode_TypeDef GPIO_Mode_X, GPIOSpeed_TypeDef GPIO_Speed_XMHZ, uint16_t GPIO_Pin, uint16_t RCC_APB2Periph);",
